...
const BUILTIN_DEFINITIONS: BuiltinDef[] = [
  ...
  /**
   * Faktenforum: overrides the vision capability that is otherwise derived from the model.
   * Needed because non-vision models on our custom endpoints (Scaleway, OpenRouter) hard-fail
   * when images reach them, and MCP tools do feed generated images back into the run.
   */
  {
    id: AgentCapabilities.vision,
    iconKey: 'vision',
    nameKey: 'com_assistants_image_vision',
    descriptionKey: 'com_agents_image_vision_info',
  },
];
